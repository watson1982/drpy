...
public class HomeActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        this.iconWiFi = findViewById(R.id.iconWiFi);
        this.iconSearch = findViewById(R.id.iconSearch);
        this.iconSettings = findViewById(R.id.iconSettings);
        ...
        iconWiFi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        iconSettings.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
    ...
    protected void onResume() {
        ...
        if (isNetworkAvailable()) {
            ...
            if (cm.getActiveNetworkInfo().getType() == ConnectivityManager.TYPE_WIFI) {
                iconWiFi.setImageDrawable(res.getDrawable(R.drawable.icon_wifi));
            } else if (cm.getActiveNetworkInfo().getType() == ConnectivityManager.TYPE_MOBILE) {
                iconWiFi.setImageDrawable(res.getDrawable(R.drawable.hm_mobile));
            } else if (cm.getActiveNetworkInfo().getType() == ConnectivityManager.TYPE_ETHERNET) {
                iconWiFi.setImageDrawable(res.getDrawable(R.drawable.hm_lan));
            }
        }

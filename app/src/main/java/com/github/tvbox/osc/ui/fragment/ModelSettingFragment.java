...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    private LinearLayout llMediaCodec;
    private LinearLayout llTunneling;
    private TextView Tunneling;
    ...
    protected void init() {
        ...
        tvSpeed.setText(Hawk.get(HawkConfig.PLAY_SPEED, false) ? "开启" : "关闭");
        ...
        llMediaCodec = findViewById(R.id.llMediaCodec);
        llTunneling = findViewById(R.id.llTunneling);
        Tunneling = findViewById(R.id.Tunneling);
        Tunneling.setText(Hawk.get(HawkConfig.EXO_TUNNELING, false) ? "打开" : "关闭");
        ...
        if (tvPlay.getText().equals("IJK")) {
            llMediaCodec.setVisibility(View.VISIBLE);
            llTunneling.setVisibility(View.GONE);
        } else if (tvPlay.getText().equals("Exo")) {
            llMediaCodec.setVisibility(View.GONE);
            llTunneling.setVisibility(View.VISIBLE);
        }
        findViewById(R.id.llIjkCachePlay).setOnClickListener((view -> {
            FastClickCheckUtil.check(view);
            Hawk.put(HawkConfig.IJK_CACHE_PLAY, !Hawk.get(HawkConfig.IJK_CACHE_PLAY, false));
            tvIjkCachePlay.setText(Hawk.get(HawkConfig.IJK_CACHE_PLAY, false) ? "开启" : "关闭");
        }));
        findViewById(R.id.llTunneling).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FastClickCheckUtil.check(v);
                Hawk.put(HawkConfig.EXO_TUNNELING, !Hawk.get(HawkConfig.EXO_TUNNELING, false));
                Tunneling.setText(Hawk.get(HawkConfig.EXO_TUNNELING, false) ? "打开" : "关闭");
                PlayerHelper.init();
            }
        });
        ...
        findViewById(R.id.llHomeApi).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sites.size() > 0) {
                    ...
                    int spanCount;
                    spanCount = (int)Math.floor(sites.size()/60.0);
        ...
        findViewById(R.id.llSpeed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FastClickCheckUtil.check(v);
                Hawk.put(HawkConfig.PLAY_SPEED, !Hawk.get(HawkConfig.PLAY_SPEED, false));
                tvSpeed.setText(Hawk.get(HawkConfig.PLAY_SPEED, true) ? "开启" : "关闭");
            }
        });
        // Select PLAYER Type --------------------------------------------
        ...
        findViewById(R.id.llClearCache).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

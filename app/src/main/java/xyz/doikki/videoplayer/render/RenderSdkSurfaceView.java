...
public class RenderSdkSurfaceView extends SurfaceView {
    ...
    public RenderSdkSurfaceView(Context context) {
        this(context, null);
    }

    public RenderSdkSurfaceView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RenderSdkSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {

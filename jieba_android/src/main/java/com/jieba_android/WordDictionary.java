package com.jieba_android;

import static com.jieba_android.Utility.LOGTAG;
...
public class WordDictionary {
    private static final String MAIN_DICT = "fenci/dict.txt";
    private static final String DICT_STOP_WORDS = "fenci/stop_words.txt"; //停止词文件
    private static final String MAIN_PROCESSED = "dict_processed.txt";
    private static final String OUTFILE = "fenci/" + MAIN_PROCESSED;
    private static volatile WordDictionary singleton;
    public final Map<String, Double> freqs = new HashMap<>(); // 加载中间文件的话，这里也要改
    public final HashSet<String> stopWordsSet = new HashSet<>(); //停止词
...
//      preProcess(assetManager);
        ...
        loadStopWords(assetManager);//加载停止词词典
    }
     ...
     * @param assetManager
     */
    private void loadStopWords(AssetManager assetManager) {
        BufferedReader bufr;
        try {
            InputStream in = assetManager.open(DICT_STOP_WORDS);

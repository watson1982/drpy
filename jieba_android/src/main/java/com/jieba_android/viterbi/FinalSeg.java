package com.jieba_android.viterbi;
...
import com.jieba_android.CharacterUtil;
import com.jieba_android.Node;
import com.jieba_android.Pair;
...
public class FinalSeg {
    ...
    private static final String PROB_EMIT = "fenci/prob_emit.txt";
